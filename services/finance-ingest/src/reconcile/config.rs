...
/// Secrets Manager reference for the Stripe API credential.
pub const STRIPE_API_SECRET_ARN_VAR: &str = "AEX_BILLING_WORKER_STRIPE_API_SECRET_ARN";
/// How long an unresolved effect may be recovered by exact-key replay.
pub const RETRY_WINDOW_VAR: &str = "AEX_BILLING_WORKER_UNKNOWN_EFFECT_RETRY_WINDOW_HOURS";
/// The hard page budget of one sweep.
pub const SWEEP_PAGE_VAR: &str = "AEX_BILLING_WORKER_SWEEP_PAGE";
/// The operations topic every finding is reported to.
pub const ALARM_TOPIC_VAR: &str = "AEX_BILLING_WORKER_ALARM_TOPIC_ARN";
/// The bucket issued statement artifacts are written to.
pub const STATEMENT_BUCKET_VAR: &str = "AEX_BILLING_WORKER_STATEMENT_BUCKET";
...
pub struct Config {
    ...
    /// Secrets Manager reference for the Stripe API credential.
    pub stripe_api_secret_arn: String,
...
impl Config {
        ...
        F: Fn(&str) -> Option<String>,
    {
        ...
        let stripe_api_secret_arn = arn(&lookup, STRIPE_API_SECRET_ARN_VAR)?;
...
mod tests {
    ...
    use super::{
        ALARM_TOPIC_VAR, Config, FinanceReconcileConfigError, NAMESPACE, REQUIRED_VARS,
        RETRY_WINDOW_VAR,
    };
    ...
    fn complete() -> BTreeMap<&'static str, String> {
        BTreeMap::from([
            ...
            (
                super::STRIPE_API_SECRET_ARN_VAR,
                "arn:aws:secretsmanager:eu-west-1:000000000000:secret:aex/stripe".to_owned(),
            ),
