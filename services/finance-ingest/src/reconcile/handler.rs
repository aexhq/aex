...
use super::sweep::{OperationsAlarm, ReconcileAuthority, SweepError, SweepReport};
...
mod tests {
    ...
    use super::super::sweep::{OperationsAlarm, ReconcileAuthority, SweepError, SweepReport};
