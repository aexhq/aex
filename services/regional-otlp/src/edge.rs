...
mod tests {
    ...
    #[test]
    fn this_deployable_accepts_only_the_otlp_audience() {
        assert_eq!(AUDIENCE, AssertionAudience::RegionalOtlp);
        // An assertion minted for the query role must never be accepted here.
        for other in [
