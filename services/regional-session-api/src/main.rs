...
//!
//! Exclusive responsibility: the finite session, run, operation, content-metadata, approval
//! and usage routes.
//!
...
/// Why `regional-session-api` refused to start.
...
pub enum RunError {
    ...
    #[error("`regional-session-api` has no implementation yet")]
    NotImplemented,
}
...
impl Config {
    /// Reads and validates the configuration of `regional-session-api` from the process environment.
    ///
    /// # Errors
    ///
...
/// Runs `regional-session-api` until it stops.
///
/// # Errors
///
...
mod tests {
    ...
    fn complete() -> BTreeMap<&'static str, String> {
        BTreeMap::from([
            ...
            (RESOURCE_VAR, "aex-regional_session_api-fixture".to_owned()),
    ...
    fn accepts_a_complete_environment() {
        ...
        assert_eq!(config.resource, "aex-regional_session_api-fixture");
