...
use crate::artifact::{
    ...
    Identities, Inputs, Licenses, Location, Media, Output, Provenance, ReceiptRef, Retention,
    Signature, Source, TOOL_CATALOG_SHA256_VAR, Target, Toolchain, UnitIdentity, Vulnerabilities,
    Workflow,
};
