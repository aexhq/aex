...
- Aex owns account, billing, control-plane, and Aex-specific public contracts. Neutral session and
  environment contracts belong to `aexhq/brain`; consume them from one immutable Brain revision
...
- Public request bodies are strict. Environment extension ABIs ignore unknown fields. An absent provider counter
