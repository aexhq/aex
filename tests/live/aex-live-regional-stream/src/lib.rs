//! Live-test companion package for the `regional-stream` deployable.
//!
//! Primary live concerns: 100+ sockets, slow and disconnected clients, durable cursor
//! reconnect, task drain and replay lag.
//!
