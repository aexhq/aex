//! Live-test companion package for the `stripe-webhook-edge` deployable.
//!
//! Primary live concerns: raw-body signature and version corpus, malformed events, durable
//! handoff before 2xx.
//!
