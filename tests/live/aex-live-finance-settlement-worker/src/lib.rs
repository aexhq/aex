//! Live-test companion package for the `finance-settlement-worker` deployable.
//!
//! Primary live concerns: concurrent inbox, rating, reservation and settlement, balanced
//! postings and central outage catch-up.
//!
