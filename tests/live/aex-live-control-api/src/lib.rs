//! Live-test companion package for the `control-api` deployable.
//!
...
//! unreachable authority must answer `503` rather than `401`; the merged surface
//! answering control, auth and billing routes from one listener; and the drain — `/internal/readyz`
