---
title: "Support"
description: "Where to get help, report issues, and check status for aex."
---
...
Self-service signup is intentionally gated until release. Existing invited workspaces can create API keys from the dashboard and use the SDK/CLI normally.

## Security

Report suspected credential exposure, cross-workspace access, or data isolation issues to [support@aex.dev](mailto:support@aex.dev) with `security` in the subject.
