...
# Written by `scripts/docs/generate-all.mjs` from `packages/sdk/docs/quickstart.md`.
...
Next: [registered resources](/docs/guides/resources/), [files](/docs/guides/files/), and
