...
export const USER_SCENARIOS: readonly UserScenario[] = Object.freeze([
  ...
  scenario("live.remote-mcp-is-qualified-and-invoked-through-tool-mux", ["sdk"], ["session_create", "session_message_send", "session_messages_list"], 300),
  scenario("live.sandbox-mcp-is-qualified-and-invoked-through-the-hand", ["sdk"], ["session_create", "session_message_send", "session_messages_list"], 360),
