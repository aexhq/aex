...
//!
//! Exclusive responsibility: measured and authorized transfer projection, the frontier and
//! the central outbox.
//!
...
pub enum RunError {
    ...
    #[error("`usage-transfer-worker` has no implementation yet")]
    NotImplemented,
}
...
/// Environment variable naming the usage-transfer-authority `DynamoDB` table.
pub const RESOURCE_VAR: &str = "AEX_USAGE_TRANSFER_TABLE";
...
impl Config {
    /// Reads and validates the configuration of `usage-transfer-worker` from the process environment.
    ///
    /// # Errors
    ///
...
mod tests {
    ...
    fn complete() -> BTreeMap<&'static str, String> {
        BTreeMap::from([
            ...
            (RESOURCE_VAR, "aex-usage_transfer_worker-fixture".to_owned()),
    ...
    fn accepts_a_complete_environment() {
        ...
        assert_eq!(config.resource, "aex-usage_transfer_worker-fixture");
