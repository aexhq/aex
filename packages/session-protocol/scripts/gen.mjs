...
const contracts = path.join(here, "../schemas");
const generated = path.join(here, "../src/generated");
await mkdir(generated, { recursive: true });

const schemaPath = path.join(contracts, "session.v1.json");
...
const environmentSchemaPath = path.join(contracts, "environment.json");
...
const openapiPath = path.join(contracts, "openapi.yaml");
