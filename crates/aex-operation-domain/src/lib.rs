...
pub use operation::{
    ...
    OperationFailure, OperationKind, OperationResult, OperationStatus, PersistShape, Progress,
    ProgressError, TransitionError, cancel, classify_persist, commit_point, fail, progress, start,
    succeed,
};
