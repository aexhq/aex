...
/// Maximum condition checks plus writes in one session transaction.
///
/// This is the DynamoDB `TransactWriteItems` provider ceiling. Plans fail
/// closed here rather than being split and losing atomicity.
