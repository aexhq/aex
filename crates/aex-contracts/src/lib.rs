//! aex contracts.
//!
//! The JSON Schema files under `contracts/` are the single source of truth. `abi` and `session`
//! are generated from them by `tools/gen.sh` (cargo-typify) and must not be hand-edited; CI fails
