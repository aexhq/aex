//! `aex-usage-transfer-dynamodb` is the `usage-transfer-authority` adapter: table expressions,
...
//!
//! - storage, compute or memory facts (`aex-usage-storage-dynamodb`,
//!   `aex-usage-compute-dynamodb`); this crate depends on
