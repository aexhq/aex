...
use crate::expressions::{ReceiptRow, StorageAuthority, StoreError, TransactItem, WRITE_ONCE};
...
/// The `usage-storage-authority` port implementation.
#[derive(Debug, Clone)]
...
impl StorageStore {
    ...
    pub fn new(
        ...
        Self {
            ...
            region,
            clock,
            expressions: StorageAuthority::new(),
...
#[async_trait]
impl AuthorityStore for StorageStore {
