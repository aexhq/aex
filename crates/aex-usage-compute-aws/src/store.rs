...
use crate::expressions::{ComputeAuthority, ReceiptRow, StoreError, TransactItem, WRITE_ONCE};
...
/// The `usage-compute-authority` port implementation.
#[derive(Debug, Clone)]
...
impl ComputeStore {
    ...
    pub fn new(
        ...
        Self {
            ...
            region,
            clock,
            expressions: ComputeAuthority::new(),
...
#[async_trait]
impl AuthorityStore for ComputeStore {
