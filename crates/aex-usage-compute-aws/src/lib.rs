//! `aex-usage-compute-aws` is the `usage-compute-authority` adapter: table expressions,
...
//!
//! - storage or transfer facts (`aex-usage-storage-aws`,
...
pub use expressions::{
    AdmissionTransaction, ComputeAuthority, FRONTIER_CAS, StoreError, TransactItem, WRITE_ONCE,
};
