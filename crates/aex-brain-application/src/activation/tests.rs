...
use crate::ports::{
    ...
    DispatchTicket, EffectStore as _, FenceGuard, FoldSnapshotStore as _, JournalCursor,
    JournalPage, LeaseStore as _, PreviewSink, ProviderDispatchError, ProviderFailureKind,
    ProviderOutcome, ProviderPort, RedactedDetail, ReleaseDisposition, SnapshotDiagnostic,
    SnapshotPublishOutcome, StoreError, StreamBudget, UnknownResolution, WakeQueue as _,
};
