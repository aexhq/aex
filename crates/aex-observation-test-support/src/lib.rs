//! `aex-observation-test-support` owns deterministic `OTLP`, batch, query and usage fixtures plus the cleanup ledger for observation and usage authority rows.
//!
//! # Invariants
//!
...
pub use teardown::{CleanupEntry, CleanupLedger, ObservationResource};
